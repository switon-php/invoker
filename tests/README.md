# Invoker Package Tests

Test suite for the Switon Invoker package, organized by test type and speed.
...
├── Integration/   # Slower integration tests (real-world scenarios)
...
- Use `Integration/` for multi-component behavior tests
- Follow naming convention: `Invoker[Component]Test.php`
